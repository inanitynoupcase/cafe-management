...
export default function UserPage() {
  ...
  const [filteredUsers, totalUsers] = applySortFilter(USERLIST, getComparator(order, orderBy), filterName);
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      <TableRow hover key={idNhanVien} tabIndex={-1} role="checkbox" selected={selectedUser}>
